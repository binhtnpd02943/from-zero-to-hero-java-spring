...
![one-to-many](../../images/lgs1554518130613/2.jpg){:class="center-image"}
...
Chúng ta sẽ sử dụng `STS` để tạo một project có khai báo `Spring Boot` và `Jpa` để hỗ trợ cho việc demo `@ManyToOne`.
...
![one-to-many](../../images/lgs1554518130613/3.jpg){:class="center-image"}
...
![one-to-many](../../images/lgs1554518130613/4.jpg){:class="center-image"}
...
![one-to-many](../../images/lgs1554518130613/5.jpg){:class="center-image"}
