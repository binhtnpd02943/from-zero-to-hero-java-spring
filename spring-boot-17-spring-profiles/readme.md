...
![image-title-here](../../images/lgs1552901817707/2.jpg){:class="center-image"}
...
![spring-profiles](../../images/lgs1558849286501/2.jpg)
...
```
No qualifying bean of type 'lgs.learning.spring.springprofiles.LocalDatasource' available
```
