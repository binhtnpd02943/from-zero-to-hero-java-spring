...
![spring-security](../../images/lgs1556683105052/3.png)
...
![spring-security](../../images/lgs1556683105052/2.jpg)
...
import lgs.learning.springsecurityhibernatejwt.user.CustomUserDetails;

@Component
@Slf4j
public class JwtTokenProvider {
    // Đoạn JWT_SECRET này là bí mật, chỉ có phía server biết
    private final String JWT_SECRET = "lgsaaaaa";
...
import lgs.learning.springsecurityhibernatejwt.jwt.JwtAuthenticationFilter;
import lgs.learning.springsecurityhibernatejwt.user.UserService;
...
@RestController
@RequestMapping("/api")
public class lgsRestController {
...
![spring-security](../../images/lgs1556683105052/5.jpg)
...
![spring-security](../../images/lgs1556683105052/6.jpg)

Sau đó sử dụng thông tin `jwt` server trả về để thực hiện các request khác.

![spring-security](../../images/lgs1556683105052/7.jpg)
