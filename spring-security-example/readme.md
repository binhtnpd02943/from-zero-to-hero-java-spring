...
![spring-security](../../images/lgs1556592373421/2.jpg)
...
_Method_ `userDetailsService()` có tác dụng cung cấp thông tin user cho Spring Security, chúng ta _Override_ lại method này và cung cấp cho nó một `User` là `lgs`.
