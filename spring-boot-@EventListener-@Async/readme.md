...
1. 「Spring Boot #0」 Series làm chủ Spring Boot, Zero to Hero

### Cơ bản về Event & Listener

![spring-profiles](../../images/lgs1559286387703/2.jpg)
...
```
restartedMain: lgs đi tới cửa nhà !!!
restartedMain: => lgs bấm chuông và khai báo họ tên!
restartedMain: Chó ngủ dậy!!!
restartedMain: Go go!! Có người tên là lgs gõ cửa!!!
restartedMain: lgs quay lưng bỏ đi
```
...
SimpleAsyncTaskExecutor-1: Go go!! Có người tên là lgs gõ cửa!!!
```
