...
![many-to-many](../../images/lgs1554524778629/2.jpg){:class="center-image"}
...
Chúng ta sẽ sử dụng `STS` để tạo một project có khai báo `Spring Boot` và `Jpa` để hỗ trợ cho việc demo `@ManyToMany`.
...
![many-to-many](../../images/lgs1554524778629/3.jpg){:class="center-image"}
...
![many-to-many](../../images/lgs1554524778629/4.jpg){:class="center-image"}
...
// Output:
// hanoi
// [Person(id=2, name=lgs1), Person(id=3, name=lgs2)]
...
![one-to-many](../../images/lgs1554524778629/5.jpg){:class="center-image"}

`Person`
![one-to-many](../../images/lgs1554524778629/6.jpg){:class="center-image"}

`Address_Person`
![one-to-many](../../images/lgs1554524778629/7.jpg){:class="center-image"}
