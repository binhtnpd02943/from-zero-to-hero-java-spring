...
![spring-bean-life-cycle](../../images/lgs1557673850320/2.jpg)
...
```java
@ComponentScan("lgs.learning.spring.componentscan.others")
@SpringBootApplication
public class App {
    public static void main(String[] args) {
        ApplicationContext context = SpringApplication.run(App.class, args);
...
```java
@SpringBootApplication(scanBasePackages = {"lgs.learning.spring.componentscan.others", "lgs.learning.spring.componentscan.others2"})
```
