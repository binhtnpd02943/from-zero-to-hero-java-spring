...
Parameter 0 of constructor in lgs.learning.spring.helloprimaryqualifier.Girl required a single bean, but 2 were found:
	- bikini: defined in file [/spring-boot-learning/spring-boot-helloworld-@Primary - @Qualifier/target/classes/me/lgs/spring/helloprimaryqualifier/Bikini.class]
	- naked: defined in file [/spring-boot-learning/spring-boot-helloworld-@Primary - @Qualifier/target/classes/me/lgs/spring/helloprimaryqualifier/Naked.class]
```
...
```
Girl Instance: lgs.learning.spring.helloprimaryqualifier.Girl@eb9a089
Girl Outfit: lgs.learning.spring.helloprimaryqualifier.Naked@1688653c
Đang không mặc gì
```
