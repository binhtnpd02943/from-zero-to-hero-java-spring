...
import lgs.learning.spring.testinginspringboot2.Todo;
import lgs.learning.spring.testinginspringboot2.TodoRepository;

@RunWith(SpringRunner.class)
/*
 * Khi đánh dấu một class là @DataJpaTest. Spring Boot sẽ load lên tất cả các
 * Bean có liên quan tới tầng Repository Thay vì load hết tất cả Bean như
 * là @SpringBootTest
 */
@DataJpaTest
